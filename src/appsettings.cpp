...
QHash<QString, QHash<QString, QString>> buildStrings()
{
    ...
    all["zh_CN"] = {
        ...
        {"excludePages", "排除"},
        {"excludePagesNeedRange", "勾选排除时请填写要排除的页码"},
        {"needPdf", "该文件类型不支持此操作"},
        {"compressLow", "标准"},
        {"compressMid", "较高"},
        {"compressHigh", "最高"},
    ...
    all["zh_TW"] = {
        ...
        {"excludePages", "排除"},
        {"excludePagesNeedRange", "勾選排除時請填寫要排除的頁碼"},
        {"needPdf", "該檔案類型不支援此操作"},
        {"compressLow", "標準"},
        {"compressMid", "較高"},
        {"compressHigh", "最高"},
    ...
    all["en"] = {
        ...
        {"excludePages", "Exclude"},
        {"excludePagesNeedRange", "Enter page numbers to exclude when Exclude is checked"},
