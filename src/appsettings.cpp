...
QHash<QString, QHash<QString, QString>> buildStrings()
{
    ...
    all["en"] = {
        ...
        {"pickerOpen", "Open"},
        {"pickerSave", "Save"},
        {"pickerSelectFolder", "Use This Folder"},
    ...
    all["fr"] = {
        ...
        {"dark", "Sombre"},
        {"about", "À propos"},
        {"aboutTitle", "À propos de PageCase"},
        ...
        {"installConfirmTitle", "Installer la mise à jour"},
        {"installConfirmMessage", "Les modifications non enregistrées seront perdues. Continuer ?"},
        ...
        {"pages", "pages"},
        {"pickerOpenTitle", "Sélectionner des fichiers"},
        {"pickerSaveTitle", "Enregistrer le fichier"},
        {"pickerFolderTitle", "Sélectionner un dossier"},
        {"pickerCancel", "Annuler"},
        {"pickerOpen", "Ouvrir"},
        {"pickerSave", "Enregistrer"},
        {"pickerSelectFolder", "Utiliser ce dossier"},
        {"pickerFileName", "Nom du fichier"},
        {"pickerFileType", "Type de fichier"},
        {"pickerName", "Nom"},
        {"pickerSize", "Taille"},
        {"pickerModified", "Modifié"},
        {"pickerNewFolder", "Nouveau dossier"},
        {"pickerShowHidden", "Afficher les éléments masqués"},
        {"pickerUp", "Niveau supérieur"},
        {"pickerRefresh", "Actualiser"},
        {"pickerPlaceHome", "Actuel"},
        {"pickerPlaceDesktop", "Bureau"},
        {"pickerPlaceDocuments", "Documents"},
        {"pickerPlaceDownloads", "Téléchargements"},
        {"pickerPlaceComputer", "Ce PC"},
        {"pickerPathMissing", "Emplacement inaccessible"},
        {"pickerInvalidFolderName", "Nom de dossier invalide"},
        {"pickerCreateFolderFailed", "Impossible de créer le dossier"},
        {"pickerFolderExistsTitle", "Le nom existe déjà"},
        {"pickerFolderExistsMessage", "Un dossier du même nom existe déjà ici"},
        {"pickerOk", "OK"},
        {"pickerCopy", "Copier"},
        {"pickerCut", "Couper"},
        {"pickerPaste", "Coller"},
        {"pickerRename", "Renommer"},
        {"pickerDelete", "Supprimer"},
        {"pickerDeleteTitle", "Confirmer la suppression"},
        {"pickerDeleteMessageOne", "Déplacer « %1 » vers la Corbeille ?"},
        {"pickerDeleteMessageMany", "Déplacer les %1 éléments sélectionnés vers la Corbeille ?"},
        {"pickerNameExistsMessage", "Un fichier ou dossier du même nom existe déjà ici"},
        {"pickerPasteFailed", "Certains éléments n'ont pas pu être collés"},
        {"pickerRenameFailed", "Impossible de renommer"},
        {"pickerDeleteFailed", "Certains éléments n'ont pas pu être supprimés"},
        {"pickerSearch", "Rechercher dans ce dossier"},
        {"pickerOverwriteTitle", "Le fichier existe déjà"},
        {"pickerOverwriteMessage", "Un fichier du même nom existe déjà. Le remplacer ?"},
        {"pickerNewFolderName", "Nom du nouveau dossier"},
        {"pickerEmpty", "Ce dossier est vide"},
        {"pickerFilterAll", "Tous les fichiers"},
        {"pickerFilterRecent", "Récents"},
        {"pickerFilterPdf", "Documents PDF"},
        {"pickerFilterOffice", "Documents Office"},
        {"pickerFilterImages", "Images"},
        {"pickerFilterText", "Fichiers texte"},
        {"pickerRecentEmpty", "Aucun fichier récent"},
    };
